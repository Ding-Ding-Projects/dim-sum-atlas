...
- [x] Refresh the packaged changelog manifest through `v0.1.8` and make Pages resolve the latest verified installer after the Windows release workflow succeeds.
